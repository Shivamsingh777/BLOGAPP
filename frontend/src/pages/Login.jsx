...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`http://localhost:8080/api/login`, input, {
        headers: {
  ...
  return (
    <div className="flex items-center h-screen md:pt-14 md:h-[760px] ">
      ...
      <Card className="w-full max-w-md p-6 shadow-lg rounded-2xl dark:bg-gray-800 dark:border-gray-600">
         <CardHeader>
           <CardTitle className="text-center text-xl font-semibold"><h1>Login into your account</h1></CardTitle>
             ...
             <Button type="submit" className="w-full">
              {
                loading ? (
                  <>
                  <Loader2 className="mr-2 w-4 h-4 animate-spain"/>
                  Please wait
                  </>
                ) : ("Login")
              }
