    ...
    <footer className='bg-gray-800 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            ...
            <p className='mt-2'>This is a blog website, which is designed by Shivam Singh.</p>
            <p className='mt-2 text-sm'>Khiriya Gonda UP, 271310. </p>
            <p className='text-sm'>Email: shivamsingh271310@gmail.com</p>
            <p className='text-sm'>Phone: + 91 6306336163</p>
        </div>
